...
const EVENTS = {
  ...
  /** A text file made in the CRM rather than uploaded (files.md §7.4). */
  "file.created": {
    subject: "file",
    title: "{actor} made {subject}",
    when: "a text file is made in a client's folders",
    granularity: "item",
    actorKinds: ["user"],
    retention: "ordinary",
    changeKeys: ["name", "size", "attachedTo"],
  ...
  /** Its text saved again. No version is kept (decision 29), so the two sizes are the record. */
  "file.edited": {
    subject: "file",
    title: "{actor} edited {subject}",
    when: "the text of a client's text file is saved",
    granularity: "item",
    actorKinds: ["user"],
    retention: "ordinary",
    changeKeys: ["name", "size"],
    enabledByDefault: true,
  },
  ...
  "firm_file.created": {
    subject: "firm_file",
    title: "{actor} made {subject}",
    when: "a text file is made in Company or My files",
    granularity: "item",
    actorKinds: ["user"],
    retention: "ordinary",
    changeKeys: ["name", "size", "place"],
  ...
  "firm_file.edited": {
    subject: "firm_file",
    title: "{actor} edited {subject}",
    when: "the text of a file in Company or My files is saved",
    granularity: "item",
    actorKinds: ["user"],
    retention: "ordinary",
    changeKeys: ["name", "size", "place"],
