...
describe("the activity registry", () => {
  ...
  it("holds the measured inventory, with every key declared", () => {
    ...
    // and the vault's two moves (secrets.md §7, 2026-09-16): a secret changing place, and an
    ...
    // −1 on 2026-09-20: a group has no roles any more, so nothing changes one (chat.md §4.3)
